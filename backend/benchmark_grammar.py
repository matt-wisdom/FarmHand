...
test_scenarios = [
    {
        ...
        "history": [{"role": "user", "content": "Duba min yanayin Danshi na Zone 2."}],
    },
    {
        ...
        "history": [
            {
                "role": "user",
                "content": "I buy 2 bags of goat feed for 45000 naira today.",
            }
        ],
    },
    {
        "name": "Single-Turn Incomplete Log (Needs Clarification)",
        "history": [{"role": "user", "content": "Log say I buy medicine."}],
    },
    {
        ...
        "history": [
            ...
            {
                "role": "assistant",
                "content": "Wetin be di amount wey you pay for di medicine, and which animal get am?",
            },
...
def run_evaluation(llm, mode_name, use_grammar):
    ...
    for idx, scenario in enumerate(test_scenarios, 1):
        ...
        print(
            f"[Telemetry: {tokens} tokens in {elapsed:.2f}s | {tokens / elapsed:.1f} t/s]"
        )
...
if __name__ == "__main__":
    if os.path.exists(MODEL_PATH):
        ...
        print(
            f"Model file pending at {MODEL_PATH}. Place model file to run benchmark evaluation."
        )
