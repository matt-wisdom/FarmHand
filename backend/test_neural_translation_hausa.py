...
from llm_engine import chat_completion, parse_tool_calls
from translator import translate_ha_to_en, translate_en_to_ha
from database import add_animal_record, init_db
...
def test_pure_translation():
    ...
    english_text = "Isolate sick chickens immediately and ensure the pen is dry and clean."
...
def test_conversational_pidgin_and_english():
    ...
    resp_pidgin = chat_completion([{"role": "user", "content": "how fa"}], language="pidgin")
    ...
    resp_en = chat_completion([{"role": "user", "content": "hello"}], language="english")
...
def test_hausa_inventory_query():
    ...
    resp = chat_completion([{"role": "user", "content": ha_query}], farm_id="default_farm", language="hausa")
    print(f"FarmHand (Hausa response):\n{resp}\n")
